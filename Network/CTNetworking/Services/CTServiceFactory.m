...
// service name list
NSString * const kServiceIndefiniteForMain = @"kServiceIndefiniteForMain";
...
{
    if ([identifier isEqualToString:kServiceIndefiniteForMain]) {
        return [[BaseAPIService alloc] init];
    }
